...
public class BeerControllerImpl implements BeerController {
    ...
    @Override
    public ResponseEntity<BeerPagedList> getBeers(Integer pageNumber, Integer pageSize, final String beerName, final BeerStyle beerStyle) {
        ...
        BeerPagedList pagedList = beerService.getPageOfBeers(beerName, beerStyle, PageRequest.of(pageNumber, pageSize));
